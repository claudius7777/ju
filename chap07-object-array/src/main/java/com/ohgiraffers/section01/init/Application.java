package com.ohgiraffers.section01.init;//package com.chgiraffers.section01.init;

public class Application //public class Application{
{

    public static void main(String[] args)//public sttic void main(String[] args){
    {
        ...
        * 동일한 타입의 여러 인스턴스를 반환해야 하는 경우 객체배열을 이용 할 수 있다.
        * */

        Car car1 = new Car("페라리",100);// Car car1 = new Car
        Car car2 = new Car("람보르기니",200);
        Car car3 = new Car("롤르로이스",300);
