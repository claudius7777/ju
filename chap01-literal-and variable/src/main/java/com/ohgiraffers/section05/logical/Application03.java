...
public class Application03 {
    public static void main(String[] args) {
         ...
         */
        /*
         * 조건식 두개가 모두 만족해야 true를 반환하지만 앞에서 미리 false가 나오게 되면
         *뒤의 조건을 확인할 필요 없이 false를 반환한다.
         * 따라서 연산 횟수를 줄이기 위해서는 && 연산의 경우 앞에 false가 나올 가능성이 높은 저건을 작성하는 편이 좋다.
         *
         */
        int num1 = 10;
         ...
         * 조건식 둘 중 하나라도 true를  변환하면 true를 변환하기 때문에 앞에서 미리 true가 나오게 되면
         * 뒤의 조건을 확인할 필요 없이 truefmf 변환한다.
