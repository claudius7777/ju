...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *
         ...
         * 2. 강제형변환 ( 명시적 형변환) : 형변환(cost) 연산자를 이용한 강제적으로 수행하는 형변환
         *  2-1. 자동형환이 적용되지 않는 경우 강제 형변환이 필요하다.
         * */
        ...
        //int result1 =num1 + num2; //자동으로 큰 쪽 자료형인 long으로 변경후 계산하기 떄문에 int형 변수에 값을 담을 수 없다.
        ...
        /* 목차. 1-2 정수는 실수로 자동 형변환 된다.*/
        /* 필기.
        * 정수를 실수로 변경할 때 소수점 자리수가 없어도 실수형태로 표현이 가능하다.이 때 데이터 손실이 없기 때문에 자동 변환이 가능하다.
         * */
         ...
         * */
        //long eight = 888888888888888888888;       //이것도 자동으로 형변환 된 것이다.(int 범위 벗어나면 에러 발생)
        long eight = 8;
        float four = eight;
